...
// Register callbacks to perform after inline has been added
    ...
    Cap.ListActionsToggle = function () {
        var $topActions;
    ...
    $.fn.capCharactersCount = function () {
        var $elements = $(this);
        ...
        $elements.each(function () {
            var $el = $(this),
                $countEl = $('<div class="cap-char-count"></div>');
            $el.after($countEl);
        ...
        function updateCount($el) {
            var maxCount = $el.data('cap-maxcount'),
                twitterCount = $el.data('cap-twitter-count'),
                value = $el.val(),
